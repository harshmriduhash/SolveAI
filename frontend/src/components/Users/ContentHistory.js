    ...
    return (
      ...
      >
        <div className="max-w-6xl h-screen mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-white text-center mt-3 mb-6">
            Generation History
          </h2>
          <Link
            to="/generate-content"
          ...
          <div className="bg-gradient-to-r from-pink-100 to-indigo-100 shadow rounded-lg mb-3 max-h-[75vh] overflow-y-auto mt-3">
            {data?.user?.contentHistory?.length <= 0 ? (
              <div className="text-black h-auto w-auto opacity-30 text-center text-2xl m-auto py-10">
                No Content
              </div>
            ) : (
