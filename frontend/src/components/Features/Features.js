      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-300">
            Experience the power of AI with Solve-AI, an intelligent content
            generator powered by OpenAI that provides high-quality, engaging
            content tailored specifically for you. Streamline your workflow and
            elevate your creative output with content that truly resonates.
          </p>
        </div>
            ...
            {features.map((feature) => (
              ...
              >
                ...
                <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-300">
                  ...
                  <a
                    href={feature.href}
                    className="mt-6 text-sm font-semibold leading-6 text-indigo-400"
                  >
